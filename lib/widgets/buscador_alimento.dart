...
class _MacroChips extends StatelessWidget {
  ...
  const _MacroChips({required this.base});
  ...
  Widget build(BuildContext context) {
    return Wrap(
      ...
      children: [
        ...
        if (base.proteinas > 0)
          _chip('P: ${base.proteinas.toStringAsFixed(1)} g', const Color(0xFF1976D2)),
        if (base.carbohidratos > 0)
          _chip('C: ${base.carbohidratos.toStringAsFixed(1)} g', const Color(0xFF388E3C)),
        if (base.grasas > 0)
          _chip('G: ${base.grasas.toStringAsFixed(1)} g', const Color(0xFF7B1FA2)),
